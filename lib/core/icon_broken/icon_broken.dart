...
class IconBroken {
  ...
  static const IconData arrowDown_2 =
      IconData(0xe904, fontFamily: _fontFamily);
  static const IconData arrowDown_3 =
  ...
  static const IconData arrowLeft_2 =
      IconData(0xe909, fontFamily: _fontFamily);
  static const IconData arrowLeft_3 =
  ...
  static const IconData arrowUp = IconData(0xe917, fontFamily: _fontFamily);
  static const IconData bag2 = IconData(0xe918, fontFamily: _fontFamily);
  ...
  static const IconData callMissed = IconData(0xe91d, fontFamily: _fontFamily);
  static const IconData callSilent = IconData(0xe91e, fontFamily: _fontFamily);
  ...
  static const IconData filter2 = IconData(0xe92e, fontFamily: _fontFamily);
  ...
  static const IconData image2 = IconData(0xe936, fontFamily: _fontFamily);
  static const IconData image = IconData(0xe937, fontFamily: _fontFamily);
  static const IconData infoCircle = IconData(0xe938, fontFamily: _fontFamily);
  static const IconData infoSquare = IconData(0xe939, fontFamily: _fontFamily);
  ...
  static const IconData moreCircle = IconData(0xe93f, fontFamily: _fontFamily);
  static const IconData moreSquare = IconData(0xe940, fontFamily: _fontFamily);
  ...
  static const IconData paperFail = IconData(0xe943, fontFamily: _fontFamily);
  static const IconData paperNegative =
      IconData(0xe944, fontFamily: _fontFamily);
  static const IconData paperPlus = IconData(0xe945, fontFamily: _fontFamily);
  ...
  static const IconData shieldDone = IconData(0xe950, fontFamily: _fontFamily);
  static const IconData shieldFail = IconData(0xe951, fontFamily: _fontFamily);
  ...
  static const IconData tickSquare = IconData(0xe955, fontFamily: _fontFamily);
  static const IconData ticketStar = IconData(0xe956, fontFamily: _fontFamily);
  ...
  static const IconData timeSquare = IconData(0xe959, fontFamily: _fontFamily);
  ...
  static const IconData voice2 = IconData(0xe95d, fontFamily: _fontFamily);
  static const IconData voice = IconData(0xe95e, fontFamily: _fontFamily);
  static const IconData volumeDown = IconData(0xe95f, fontFamily: _fontFamily);
  static const IconData volumeOff = IconData(0xe960, fontFamily: _fontFamily);
  static const IconData volumeUp = IconData(0xe961, fontFamily: _fontFamily);
